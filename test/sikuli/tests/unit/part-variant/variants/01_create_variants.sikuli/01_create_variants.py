...
try:
    ...
    find(Pattern("variant_list_add_11.png").exact())
    click(Pattern("variant_list_add_03.png").exact().targetOffset(0,20))
    mouseMove(-100, 0); click(Pattern("variant_list_add_04.png").exact())
    mouseMove(-100, 0); find(Pattern("variant_list_add_05.png").exact())
    click(Pattern("variant_list_add_10.png").exact().targetOffset(0,-29))
    find(Pattern("variant_list_add_12.png").exact())
    click(Pattern("variant_list_add_13.png").exact().targetOffset(0,-5))
    click(Pattern("variant_list_add_10.png").exact().targetOffset(0,-30))
    find(Pattern("variant_list_add_14.png").exact())
