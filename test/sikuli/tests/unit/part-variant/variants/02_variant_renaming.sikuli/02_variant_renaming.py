...
try:
    ...
    doubleClick(Pattern("variant_list_add_14.png").similar(0.91).targetOffset(-60,-26))
    type("var" + Key.ENTER)
    find(Pattern("variant_list_add_16.png").exact())
    doubleClick(Pattern("variant_list_add_17.png").similar(0.91).targetOffset(-53,-4))
    type("var1" + Key.ENTER)
    find(Pattern("variant_list_add_18.png").exact())
    doubleClick(Pattern("variant_list_add_19.png").similar(0.91).targetOffset(-56,15))
    type("var2" + Key.ENTER)
